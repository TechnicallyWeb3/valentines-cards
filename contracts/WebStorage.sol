...
contract DataPointRegistry {
    ...
    /// @notice Custom error for insufficient royalty payment
    /// @param paid The amount of royalty paid
    /// @param expected The expected royalty amount
    error InsufficientRoyalty(uint256 paid, uint256 expected);
        ...
        if (dataPointInfo.size == 0) {
            ...
            if (
                ...
                if (msg.value < gasCost) {
                    revert InsufficientRoyalty(msg.value, gasCost);
                }
